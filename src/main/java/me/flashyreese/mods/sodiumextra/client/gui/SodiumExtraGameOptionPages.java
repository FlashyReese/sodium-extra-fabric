...
public class SodiumExtraGameOptionPages {
    ...
    public static OptionPage animation() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.animation").isEnabled())
    ...
    public static OptionPage particle() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.particle").isEnabled())
                        .setName(parseVanillaString("gui.socialInteractions.tab_all"))
    ...
    public static OptionPage detail() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.sky").isEnabled())
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.stars").isEnabled())
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.sun_moon").isEnabled())
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.biome_colors").isEnabled())
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.sky_colors").isEnabled())
    ...
    public static OptionPage render() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.fog").isEnabled())
                ...
                .add(OptionImpl.createBuilder(int.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.fog_falloff").isEnabled())
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.sodium.biome_blend").isEnabled())
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.light_updates").isEnabled())
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.render.entity").isEnabled())
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.render.block.entity").isEnabled())
    ...
    public static OptionPage extra() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.reduce_resolution_on_mac").isEnabled() && MinecraftClient.IS_SYSTEM_MAC)
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(int.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.cloud").isEnabled())
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.toasts").isEnabled())
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.instant_sneak").isEnabled())
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.prevent_shaders").isEnabled())
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setEnabled(SodiumExtraClientMod.options().getMixinConfig().getOptions().get("mixin.steady_debug_hud").isEnabled())
