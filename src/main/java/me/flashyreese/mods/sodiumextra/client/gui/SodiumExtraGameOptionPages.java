    ...
    public static OptionPage extra() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodium-extra.option.advancementToast"))
                        .setTooltip(Text.translatable("sodium-extra.option.advancementToast.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.extraSettings.advancementToast = value, options -> options.extraSettings.advancementToast)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodium-extra.option.recipeToast"))
                        .setTooltip(Text.translatable("sodium-extra.option.recipeToast.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.extraSettings.recipeToast = value, options -> options.extraSettings.recipeToast)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodium-extra.option.systemToast"))
                        .setTooltip(Text.translatable("sodium-extra.option.systemToast.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.extraSettings.systemToast = value, options -> options.extraSettings.systemToast)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodium-extra.option.tutorialToast"))
                        .setTooltip(Text.translatable("sodium-extra.option.tutorialToast.tooltip"))
                        .setControl(TickBoxControl::new)
