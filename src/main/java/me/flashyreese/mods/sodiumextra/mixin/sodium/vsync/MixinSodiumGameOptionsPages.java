...
public class MixinSodiumGameOptionsPages {
    ...
    @Redirect(method = "general", at = @At(value = "INVOKE", target = "Lme/jellysquid/mods/sodium/client/gui/options/OptionGroup$Builder;add(Lme/jellysquid/mods/sodium/client/gui/options/Option;)Lme/jellysquid/mods/sodium/client/gui/options/OptionGroup$Builder;", ordinal = 4), remap = false)
    private static OptionGroup.Builder redirectVsyncToggle(OptionGroup.Builder instance, Option<?> option) {
        ...
        return instance.add(OptionImpl.createBuilder(SodiumExtraGameOptions.VerticalSyncOption.class, SodiumExtraGameOptionPages.sodiumExtraOpts)
                ...
                .setTooltip(new LiteralText(new TranslatableText("sodium.options.v_sync.tooltip").getString() + "\n- " + new TranslatableText("sodium-extra.option.use_adaptive_sync.name").getString() + ": " + new TranslatableText("sodium-extra.option.use_adaptive_sync.tooltip").getString()))
